...
function assertCors(req, res, opt_validMethods, opt_exposeHeaders, opt_ignoreMissingSourceOrigin) {
    ...
    const ORIGIN_REGEX = new RegExp('^http://localhost:3000|' + '^https?://hrfmmymt.github.io');
    const SOURCE_ORIGIN_REGEX = new RegExp('^http://localhost:3000|' + '^https?://hrfmmymt.github.io');
